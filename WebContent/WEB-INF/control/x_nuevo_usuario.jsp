        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
		    ...
		    <div class="form-group">
			  ...
			  <p></p>
		    <div class="form-group">
				  <p class="card-footer text-muted">*Debe introducirse un nuevo usuario en cada linea siguiendo el siguiente formato:<br> NIA Apellidos Nombre<br> NIA2 Apellidos2 Nombre2<br> ...</p>
				  <p class=" text-muted">Ejemplo:</p>
			  <textarea class="form-control" placeholder="123456 Pérez Galbán Rodrigo" disabled="" rows="3" ></textarea>
              </div>
