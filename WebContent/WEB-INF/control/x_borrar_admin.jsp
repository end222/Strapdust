   ...
   <body id="page-top" class="sidebar-toggled">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
		...
		<li class="breadcrumb-item active">Borrar administradores</li>
          </ol>
          <!-- DataTables Example -->
	...
	<div> <a class="alert alert-secondary btn-block" href="ComprobarSeguridadTabla.do?direccion=x_borrar_usuarios" role="alert">
