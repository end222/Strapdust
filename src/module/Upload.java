...
public class Upload extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    Pregunta preg3 = new Pregunta(3, 0, String.valueOf(request.getParameter("enunciado3")), String.valueOf(request.getParameter("pregunta31")), String.valueOf(request.getParameter("pregunta32")), String.valueOf(request.getParameter("pregunta33")), (request.getParameter("respuesta31") != null) ? 1 : 0, (request.getParameter("respuesta32") != null) ? 1 : 0, (request.getParameter("respuesta33") != null) ? 1 : 0, String.valueOf(request.getParameter("explicacion3")));
	    Cartel cartel = new Cartel(0, String.valueOf(request.getParameter("titulo")), String.valueOf(request.getParameter("noticia")), "", String.valueOf(request.getParameter("opinion")), String.valueOf(request.getParameter("reto")), 1, new Timestamp(0), String.valueOf(request.getParameter("enlace")));
